...
public class VoxeetConferenceView extends AbstractVoxeetExpandableView implements IParticipantViewListener, VoxeetSpeakersTimerInstance.ActiveSpeakerListener {
    ...
    public void onConferenceFromNoOneToOneUser() {
        ...
        Conference conference = VoxeetSDK.conference().getConference();
            conferenceActionBarView.setChatButton(true);

       /* for (int i = 0; i < conference.getParticipants().size(); i++) {
            if (conference.getParticipants().get(i).isLocallyActive() && VoxeetSDK.session().getParticipantInfo().getName().equalsIgnoreCase(conference.getParticipants().get(i).getInfo().getName())) {
    ...
    public void onConferenceNoMoreUser() {
        ...
        conferenceActionBarView.setChatButton(false);
    ...
    protected void bindView(View view) {
        try {
            ...
            conferenceActionBarView.setChat(actionBarConfiguration.displayChat);
